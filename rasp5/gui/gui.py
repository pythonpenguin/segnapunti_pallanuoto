...
class Tabellone(QMainWindow, tabellone.Ui_TabelloneLED):
    def __init__(self, controller: game_controller.GameController,broker=BROKER):
        ...
        self.mc_action_pni_master.triggered.connect(lambda: self._load_categoria("pni_master"))
        self.mc_action_pni_u11.triggered.connect(lambda: self._load_categoria("pni_u11"))
        self.mc_action_pni_u13.triggered.connect(lambda: self._load_categoria("pni_u13"))
        self.mc_action_pni_u15.triggered.connect(lambda: self._load_categoria("pni_u15"))
        self.mc_action_pni_u17.triggered.connect(lambda: self._load_categoria("pni_u17"))
        self.mc_action_pni_u19.triggered.connect(lambda: self._load_categoria("pni_u19"))
        self.mc_action_pni_u22.triggered.connect(lambda: self._load_categoria("pni_u22"))
